// index.js — SavoPay backend (savopay-webhooks): prod CORS, admin auth, receipts, webhook, auto-recheck, security headers, rate limit
...
app.post('/admin/recheck-pending', requireAdmin, async (_req, res) => {
  try {
    const count = await recheckCycle();
